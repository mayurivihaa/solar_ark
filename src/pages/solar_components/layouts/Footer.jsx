  ...
  <div className="container mx-auto px-4 lg:flex lg:justify-between text-gray-600">
    ...
    <div className="mb-6 lg:mb-0 lg:w-1/4">
      <div className="flex items-center  text-center justify-center mb-4">
        <img src={`${process.env.PUBLIC_URL}/assets/main-logo.jpeg`} alt="Logo" className="h-15 w-60" />
      </div>
      <p className="mt-4 text-sm  text-center justify-center">
        Lorem ipsum dolor sit amet consectetur. Cursus elementum diam nunc liberoLorem ipsum dolor sit amet consectetur.
      </p>
    ...
    <div className="lg:flex flex lg:space-x-8 w-full mb-6  text-center justify-center  lg:mb-0 lg:w-1/2">
      ...
      <div className="mb-6 lg:mb-0 lg:w-1/2 ">
        ...
        <ul className="space-y-2 text-sm">
          ...
          <li><a href="#calculator" className="hover:underline">Solar Calculator</a></li>
          <li><a href="#services" className="hover:underline">Services</a></li>
          <li><a href="#suryamitra" className="hover:underline">Suryamitra</a></li>
        </ul>
      </div>
